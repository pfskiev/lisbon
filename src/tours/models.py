...
class BaseClass(models.Model):
    ...
    description_PT = models.TextField(_('Description PT'), max_length=2000, blank=True, null=False)
    description_EN = models.TextField(_('Description EN'), max_length=2000, blank=True, null=False)
    description_DE = models.TextField(_('Description DE'), max_length=2000, blank=True, null=False)
